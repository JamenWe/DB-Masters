...
export type NutritionalCategoriesFilterBoxProps = {
    filter?: NutritionalCategoryFilterType;
    fixedFilterKeys?: (keyof NutritionalCategoryFilterType)[];
    onChange?: (filter: NutritionalCategoryFilterType) => void;
    onClear?: () => void;
};

const NutritionalCategoriesFilterBox: FC<NutritionalCategoriesFilterBoxProps> = (props) => {
...
export default NutritionalCategoriesFilterBox;