...
import {OrderIngredientRequest} from 'src/api/orders';
import {hideNumberInputArrows} from "src/util/styles";
import {Link as RouterLink} from "react-router-dom";

interface OrderIngredientsEditorProps {
    availableIngredients: IngredientType[];
    selectedIngredients: OrderIngredientRequest[];
    onChange: (ingredients: OrderIngredientRequest[]) => void;
}

const OrderIngredientsEditor: FC<OrderIngredientsEditorProps> = ({
...
export default OrderIngredientsEditor;